...
public class Program
{
    static void Demo6()
    {
      ...
      WriteLine($"Digite o número que gostariade encontrar");
    ...
    static void Demo5()
    {
       ...
       WriteLine($"Os imparares {string.Join(",", pares)} ");
    ...
    {  
      ...
      List<Pessoa> pessoas = new List<Pessoa>()
      {
          ...
          new Pessoa(){Nome = "Luziano"},
          new Pessoa(){Nome = "ALice"},
          new Pessoa(){Nome = "Guilherme"},
          new Pessoa(){Nome = "Andrezza"},
      ...
      {
          WriteLine("Pessoas não encontrada");
      }
